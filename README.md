...
- Spécial : <a href=https://github.com//Deratiseur/Kensai>Le Kensaisateur</a> : faites de n'importe quel personnage un kensai (en plus de sa classe normale).   
...
- Special: <a href=https://github.com//Deratiseur/Kensai>The Kensaisator</a>: Make any character a kensai (in addition to his normal class).  

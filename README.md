...
Des modules de kits :
[Deratiseur's Unused kits Pack (DUKP)](https://github.com/Deratiseur/DUKP) : des kits classiques.
Deratiseur's Absolute Wacky Adventurers Pack (DAWAP) : des kits très originaux.

Des modules de magasins :
...
Des mods pour gagner en puissances :
...
Un mod pensé pour les moddeurs :
